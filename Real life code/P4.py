...
class WaypointExecutor(Node):
    def __init__(self):
        ...
        ##Pose 4
        self.waypoints =[
            self.create_waypoint(-1.2, 0.62, 0.0, 0.0, 0.0, 1.0, -0.12),
            self.create_waypoint(-1.6, 0.62, 0.0, 0.0, 0.0, 1.0, -0.12),
            self.create_waypoint(-2.0, 0.62, 0.0, 0.0, 0.0, 1.0, -0.12),
            self.create_waypoint(-2.46, 0.62, 0.0, 0.0, 0.0, 1.0, -0.12),
            self.create_waypoint(-2.59, 0.48, 0.0, 0.0, 0.0, 0.79, 0.6),
            self.create_waypoint(-2.59, 1.06, 0.0, 0.0, 0.0, 0.79, 0.6),
            self.create_waypoint(-2.57, 2.24, 0.0, 0.0, 0.0, 0.79, 0.6),
            self.create_waypoint(-2.57, 2.6, 0.0, 0.0, 0.0, 0.79, 0.6),
