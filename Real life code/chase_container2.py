...
class ContainerChaser(Node):
    def __init__(self):
        ...
        self.declare_parameter("desired_midpoint_y", 148)
    ...
    def listener_callback(self, msg):
        cmd_vel_msg = Twist()
        if not ((self.desired_midpoint_x - 10) <= msg.x <= (self.desired_midpoint_x + 10)):
        ...
        if ((self.desired_midpoint_x - 15) <= msg.x <= (self.desired_midpoint_x + 15)) and ((self.desired_midpoint_y - 5) <= msg.y <= (self.desired_midpoint_y + 5)):
            print("end")
