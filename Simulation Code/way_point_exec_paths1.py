...
class WaypointExecutor(Node):
    def __init__(self):
        ...
        self.waypoints = [
            ...
            self.create_waypoint(-0.78, 1.4, 0.0, 0.0, 0.0, -0.43, 0.9),
            self.create_waypoint(-0.31, 0.86, 0.0, 0.0, 0.0, -0.43, 0.9),
            self.create_waypoint(0.35, 0.82, 0.0, 0.0, 0.0, 0.7, 0.7),
            self.create_waypoint(0.5, 1.2, 0.0, 0.0, 0.0, 0.7, 0.7),
            self.create_waypoint(0.47, 1.6, 0.0, 0.0, 0.0, 0.7, 0.7),
            self.create_waypoint(0.47, 2.0, 0.0, 0.0, 0.0, 0.7, 0.7),
            self.create_waypoint(0.47, 2.4, 0.0, 0.0, 0.0, 0.7, 0.7),
            self.create_waypoint(0.47, 2.8, 0.0, 0.0, 0.0, 0.7, 0.7),
            self.create_waypoint(0.47, 3.0, 0.0, 0.0, 0.0, 0.7, 0.7),
        ]
